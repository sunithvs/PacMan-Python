...
class Game(object):
    ...
    def display_frame(self, screen):
        ...
        if self.game_over:
            if self.about:
                '''
                write this in the about section
                '''
            ...
            lev = self.font.render("Level: " + str(self.level), True, GREEN)
            screen.blit(lev, [400, 20])
    ...
    def level_up(self, value):
        ...
        """
        self.level += 1
        self.player.increase_level(value)
        for enemy in self.enemies:
            enemy.increase_level(value)
